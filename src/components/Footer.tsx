      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="p-6 bg-nt-dark/40 border border-nt-charcoal rounded-2xl">
            <h4 className="font-display uppercase tracking-widest text-xs text-nt-gray mb-6 font-bold border-b border-nt-charcoal pb-2">{t.footer_explore}</h4>
          ...
          {/* Nav column 2 */}
          <div className="p-6 bg-nt-dark/40 border border-nt-charcoal rounded-2xl">
            <h4 className="font-display uppercase tracking-widest text-xs text-nt-gray mb-6 font-bold border-b border-nt-charcoal pb-2">{t.footer_services}</h4>
          ...
          <div className="p-6 bg-nt-dark/85 border border-nt-charcoal rounded-2xl flex flex-col justify-between">
            <div>
              <h4 className="font-display uppercase tracking-widest text-xs text-nt-gray mb-4 font-bold">{t.footer_newsletter_title}</h4>
              <p className="text-nt-gray font-mono text-[11px] leading-relaxed mb-6">{t.footer_newsletter_desc}</p>
            </div>
